...
const milestones: Milestone[] = [
  ...
  { id: 'n-gre-prep', date: '2026-10-10', kind: 'test', title: 'Start GRE prep (8–10 weeks)', detail: 'Needed for RWTH (accepted average ≈ Q162) and Paderborn (Q157+, AW 4.0 desirable). A strong Quant score also offsets your GPA.' },
  ...
  { id: 'n-gre', date: '2026-12-12', kind: 'test', title: 'Take the GRE General Test', detail: 'Scores reach universities about 8–10 days later, in time for RWTH (1 March) and Paderborn (31 May).' },
  ...
  { id: 'n-funds', date: '2027-07-01', kind: 'visa', title: 'Prepare proof of funds', detail: 'Germany: blocked account (€11,904 for 12 months was the 2025–2026 rate). Austria (TU Wien, TU Graz) has no blocked account: you show sufficient funds for the residence permit instead.' },
  ...
  { id: 'n-insurance', date: '2027-08-15', kind: 'visa', title: 'Get health insurance and book flights', detail: 'Public student insurance in Germany (≈ €140/month); Austrian students use the ÖGK student insurance.' },
...
export const natali: ProfileConfig = {
  ...
  tests: [
    ...
    },
    {
      ...
      target: 'Quant 162+ · Verbal 150+ · Writing 4.0',
      why: 'Required for RWTH (accepted average ≈ V151 / Q162) and Paderborn (Q157+, AW 4.0 desirable). A strong score also helps offset the GPA.',
      cost: '≈ US$220',
      validity: '5 years',
