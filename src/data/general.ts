...
export const milestones: Milestone[] = [
  ...
  { id: 'm-docs-request', date: '2026-10-20', kind: 'docs', title: 'Request documents from your university', detail: 'English transcript with ECTS and the grading scale, an English module handbook (course descriptions: RWTH calls it vital for its subject check), a list of the modules you take in your final year, and an "expected graduation" letter. For Esslingen, also a class-rank certificate.' },
  ...
  { id: 'm-juelich', date: '2027-02-01', kind: 'prep', title: '🔬 Internship at Forschungszentrum Jülich (ITE)', detail: 'Keep notes on what you simulate (FEA, thermal, flow), which tools you use and what results you get. You will need these for your CV, motivation letters and interviews. Early in the month, ask Prof. Natour whether he can write your letter before 1 March, so you can attach it at RWTH (optional there), and tell him your later deadlines (TUM, THI, KIT). Aachen is only about 30 km away, so visit RWTH and ika while you are there.' },
  { id: 'm-internship-check', date: '2026-11-10', kind: 'docs', title: 'Confirm your internship counts at KIT', detail: 'KIT requires a 12-week industrial internship. Your 6-month Nasolutions internship should cover it; email them the dates, hours and tasks to be sure. RWTH needs 16 weeks, but approves it only after enrolment, so it cannot block your admission there.' },
  { id: 'm-rwth-call', date: '2026-11-20', kind: 'docs', title: 'Advisory video call with ika (RWTH)', detail: 'ika\'s course guidance offered a video call. Send your English module handbook first and ask: which of the 12 subject areas you miss, whether your gaps stay under 30 ECTS (more means rejection), and whether Automotive Theory and Mechatronics count towards the automotive basics. If your university offers electives in vehicle dynamics or engines this year, ask whether taking them would reduce the gaps.' },
  ...
  { id: 'm-gre', date: '2026-12-12', kind: 'test', title: 'Take the GRE General Test', detail: 'Official scores reach universities about 8–10 days after the test. Taking it by mid-December leaves room for a retake before RWTH\'s 1 March deadline. Send the scores to RWTH with institution code 8504.' },
...
export const tests = [
  ...
  },
  {
    ...
    why: 'Mandatory for RWTH Automotive Engineering (non-EU citizens): minimums are V145 / Q160 / AW3.0; RWTH institution code 8504. None of the other programs on your list requires it.',
    cost: '≈ US$220',
    validity: '5 years',
