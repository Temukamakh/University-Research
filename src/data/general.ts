...
export const milestones: Milestone[] = [
  { id: 'm-shortlist', date: '2026-10-05', kind: 'prep', title: 'Finalise your shortlist', detail: 'Pick 6–8 programs: 2 reach, 3 target, 2–3 safety. Star them on the Programs page.' },
  { id: 'm-gre-prep', date: '2026-10-10', kind: 'test', title: 'Start GRE prep (8–10 weeks)', detail: 'Only RWTH requires it, but it is your 1st choice. Target: Quant 165+, Verbal 150+, Writing 3.5+. RWTH\'s minimums are V145 / Q160 / AW3.0.' },
  ...
  { id: 'm-lor', date: '2026-11-01', kind: 'docs', title: 'Ask 2 professors for recommendation letters', detail: 'Give them your CV, your target programs and the deadlines. Ask your Automotive Theory or Machine Elements professor, and your senior-project supervisor.' },
  ...
  { id: 'm-sop', date: '2026-12-20', kind: 'docs', title: 'Write your CV and motivation letters', detail: 'Write one core letter, then tailor it for each program: why this program, which modules, how your agricultural-machinery and automotive background fits.' },
...
export const tests = [
  {
    ...
    why: 'Covers every program on your list. Stuttgart FAME asks for C1 (≈7.0), TUHH 6.5, and most others 6.0–6.5.',
