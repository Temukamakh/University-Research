...
export const milestones: Milestone[] = [
  ...
  { id: 'm-lor', date: '2026-11-01', kind: 'docs', title: 'Ask for 2–3 recommendation letters', detail: 'Give each person your CV, target programs and deadlines. Ask a professor (Automotive Theory, Machine Elements or FEM) and your senior-project supervisor. Ask your Forschungszentrum Jülich supervisor too, if the internship starts before your deadlines. A Helmholtz reference carries a lot of weight.' },
